...
<head>
    ...
    <title>Login - Kopano Manyano</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <script type="module">
        ...
        import { getAuth, signInWithEmailAndPassword, setPersistence, browserLocalPersistence, browserSessionPersistence, getIdToken } from "https://www.gstatic.com/firebasejs/11.9.1/firebase-auth.js";
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            if (!emailInput || !passwordInput || !rememberInput || !submitBtn || !errorMsg || !successMsg) {
            ...
            try {
                ...
                const response = await fetch('/My%20Website/php/login_process.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                    body: `idToken=${encodeURIComponent(idToken)}&email=${encodeURIComponent(email)}&remember=${remember ? 1 : 0}`
                });
                ...
                if (result.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = '/My%20Website/html/Home%20Page.html?success=' + encodeURIComponent(`Login successful! Welcome, ${result.username}.`);
                    }, 2000);
                } else {
                    throw new Error(result.error || 'Failed to process login.');
                }
            } catch (error) {
